...
class Options():
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--train_graph', type=str, default='none', help='path of train data')
        self.parser.add_argument('--eval_graph', type=str, default='none', help='path of eval data')
        self.parser.add_argument('--test_graph', type=str, default='none', help='path of test data')
        self.parser.add_argument('--dataset', type=str, default='webq', help='path of test data')
        ...
        self.parser.add_argument('--text_maxlength', type=int, default=256, 
        ...
        self.parser.add_argument('--gnn_layer', type=int, default=2)
        self.parser.add_argument('--gnn_dimension', type=int, default=768)
        self.parser.add_argument('--add_residual', action='store_true', help='add residual connection for GNN')
        self.parser.add_argument('--is_distributed', action='store_true', help='is_distributed')
        self.parser.add_argument('--gnn_dropout', type=float, default=0.3, help='drop out rate for gnn')
        self.parser.add_argument('--layer2insert', type=int, default=10)
        self.parser.add_argument('--bpe', action='store_true', help='whether or not back propagate through gnn back to encoder')
        self.parser.add_argument('--warmed_gnn', type=str, default='none', help='path to warmed gnn')
        self.parser.add_argument('--wandb', action='store_true', help='enable wandb functionality')
        self.parser.add_argument('--ground_truth_for_test', type=str, help='json 1-hop solvable')
        self.parser.add_argument('--relation_base', type=str, help='json name for involved relations')
        self.parser.add_argument('--n_heads', type=int, help='Number of gnn heads')
        self.parser.add_argument('--gnn_mode', type=str, default='EGAT', help='type of gnn')
        
    def add_gnn_warmup_options(self):
        self.parser.add_argument('--train_data_json', type=str, default='none', help='path of train data json')
        self.parser.add_argument('--eval_data_json', type=str, default='none', help='path of eval data json')
    ...
    def add_retriever_options(self):
        ...
        self.parser.add_argument('--passage_maxlength', type=int, default=256, 
    ...
    def initialize_parser(self):
        ...
        self.parser.add_argument('--use_mpi', action='store_true',
                        help='use openMPI for pytorch distributed training')
